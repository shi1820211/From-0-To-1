...
def extract_category_from_header(header):
    ...
    if "视为致病菌" in header:
        return "致病菌"
    elif "视为定植菌" in header:
        return "定植菌"
    elif "视为正常菌" in header:
        return "正常菌"
    # 如果表头格式不同，尝试其他匹配方式
    elif "致病菌" in header and "视为" not in header:
        return "致病菌"
    elif "定植菌" in header and "视为" not in header:
        return "定植菌"
    elif "正常菌" in header and "视为" not in header:
        return "正常菌"
    else:
        return "未知"
