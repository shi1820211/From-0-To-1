...
with open("mydata_processed.jsonl", "w", encoding="utf-8") as f:
    for item in dataset:
        f.write(json.dumps({k: v.tolist() if hasattr(v, 'tolist') else v for k, v in item.items()}, ensure_ascii=False) + "\n")
